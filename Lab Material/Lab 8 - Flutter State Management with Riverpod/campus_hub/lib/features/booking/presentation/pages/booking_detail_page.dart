...
import '../../../session_management/presentation/providers/session_notifier.dart';
...
class _BookingDetailPageState extends ConsumerState<BookingDetailPage> {
  ...
  void initState() {
    ...
    // Requirements: Call loadBookingById() method with the booking ID
    // Hint: Use ref.read() for one-time actions in initState
    // Hint: The booking ID is available in widget.bookingId
    // Hint: Access notifier methods using .notifier on the provider
  }

  @override
  Widget build(BuildContext context) {
    // TODO 21: Watch the booking state to get selected booking
    // Requirements: Watch the booking provider and get the selectedBooking
    // - Use ref.watch() to listen for state changes
    // - Access the selectedBooking property from the state
    // Hint: Use ref.watch() in build() for reactive UI
    // Hint: The state object has a .selectedBooking property
    // Hint: Replace null below with the selectedBooking from state

    // For now, booking is null until students implement TODOs
    final booking = null; // Replace this with the selectedBooking from state

    // Session info is not shown for now
    // Students will implement this in future labs
    final session = null;
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Complete the TODO to load booking',
              style: TextStyle(
                fontSize: 14,
