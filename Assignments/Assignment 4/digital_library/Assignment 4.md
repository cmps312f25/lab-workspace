...
### 1. Update Repository Implementations (100 points)
...
| ----------------------------------- | ------------- | ---------------------------------------------------- |
| **AuthorRepositoryImpl**      | 20            | All read operations and search work with API         |
| **LibraryRepositoryImpl**     | 30            | All read operations and filters work with API        |
| **MemberRepositoryImpl**      | 20            | All read operations and search work with API         |
| **TransactionRepositoryImpl** | 30            | All read operations and filters work with API        |
